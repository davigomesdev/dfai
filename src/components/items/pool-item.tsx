        ...
        {poolDayData.length > 0 ? (
          <ul className="space-y-4">
            ...
            <li>
              ...
              <Typography.P className="text-sm">${numeral(tvlTotal).format('0.00a')}</Typography.P>
              <div>
                <Chart
                  className="pointer-events-none max-h-[30px] min-h-[30px] w-full"
            ...
            <li>
              <Typography.P className="text-[0.6rem] text-secondary-200">fees/TVL 30d</Typography.P>
              <Typography.P className="text-sm">${numeral(feesTotal).format('0.00a')}</Typography.P>
              <div>
                <Chart
                  className="pointer-events-none max-h-[30px] min-h-[30px] w-full"
                  config={chartTVLAndFeesConfig}
