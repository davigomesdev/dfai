...
import { GithubLogo, TelegramLogo, XLogo } from '@phosphor-icons/react';
      ...
      <Wrapper className="flex flex-col items-center overflow-hidden">
        ...
        <nav className="sticky flex w-full items-center justify-between gap-2 border-b border-white p-2 md:p-5 md:py-8">
          ...
          <ul className="flex items-center gap-2">
            ...
            <li>
              <Link className={cn(buttonVariants())} to={PageUrlEnum.TOP_POSITIONS}>
                JOIN US
              </Link>
            </li>
          </ul>
        ...
        <Wrapper>
          <div className="mt-10 flex w-full flex-col items-center justify-between gap-10 md:flex-row md:items-end">
            <Typography.P className="w-full max-w-[300px] text-center md:text-left">
              Join the DFAI ecosystem and stay updated on everything happening in our project.
              Follow us on Telegram for real-time updates, join the conversation on Twitter, and
              explore our Whitepaper to understand the full potential of our platform.
            </Typography.P>
